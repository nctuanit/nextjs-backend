...
import './globals.css';
export const metadata: Metadata = { title: 'Dev Mode | next-js-backend', description: 'DevModeModule · request logging · route inspector' };
      ...
      <div className="layout">
        <aside className="sidebar">
          <div className="sidebar-header">
            ...
            <div className="sidebar-title">12 · Dev Mode</div>
            <div className="sidebar-desc">DevModeModule · Request Logger</div>
          </div>
          <nav className="sidebar-nav">
            <div className="nav-group-label">Features</div>
            {[{ label: 'DevModeModule.register()', desc: 'enabled · showRoutes · logRequests' }, { label: 'DevModeLoggerMiddleware', desc: 'Automatic request/response logging' }, { label: 'DevModeService', desc: 'Route inspection + metrics' }].map(f => (
            ...
            {['GET /api/demo/hello', 'GET /api/demo/error', 'POST /api/demo/echo', 'GET /api/demo/log'].map(r => (
          ...
          <div style={{ padding: '1rem 1.25rem', borderTop: '1px solid var(--border)' }}><span className="badge badge-blue">Sample 12/13</span></div>
        </aside>
