...
import { Book, Code, Component, GitFork, Play, Shield, Layers, Box, AlertTriangle, FileJson, BookOpen, Rocket, MonitorPlay, Boxes, ShieldAlert, ArrowLeftRight, Filter, Globe } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
      ...
      <div className="container flex-1 items-start md:grid md:grid-cols-[240px_minmax(0,1fr)] lg:grid-cols-[280px_minmax(0,1fr)] max-w-screen-2xl px-8">
        ...
        {/* Right Content Area */}
        <main className="relative py-10 lg:gap-10 xl:grid xl:grid-cols-[1fr_250px] w-full min-w-0">
